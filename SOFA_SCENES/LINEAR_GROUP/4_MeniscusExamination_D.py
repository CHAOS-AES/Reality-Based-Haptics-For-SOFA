...
def createScene(rootNode):
    ...
    if addLateralMeniscus == True:
        ...
        lateralMeniscus.addObject('TetrahedralCorotationalFEMForceField', template="Vec3d", name="FEM", poissonRatio="0.29", youngModulus="2.67") # 3.84
    ...
    if addLateralMeniscus == True:
        ...
        lateralMeniscus2.addObject('TetrahedralCorotationalFEMForceField', template="Vec3d", name="FEM", poissonRatio="0.29", youngModulus="4.24") # 3.84
...
class MatrixAccessController(Sofa.Core.Controller):
    ...
    def onAnimateEndEvent(self, event):
        ...
        if exportCSV:
            ...
            with open("C:/Users/objel/Documents/userStudyMeniscus/USER_DATA/meniscusExaminationForces_Test4.csv", "a") as csv_file:
            ...
            with open("C:/Users/objel/Documents/MENISCUS_EXAMINATION_SIMULATOR/SOFAPYTHON3/simulationReactionForce_Test4.csv", "a") as csv_file:

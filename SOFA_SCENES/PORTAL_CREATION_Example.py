...
def createScene(rootNode):
    ...
    if addPortal == True:
        ...
        portalVisual.addObject('MeshOBJLoader', name="loader", filename="mesh/torus.obj", rotation="60 180 110", translation="-60 -28 -45", scale3d="4.5 4.5 4.5") 
        portalVisual.addObject('OglModel', name="portalVisualModel", src="@loader", color="0.47 0.96 0.89 0.96") 
...
class MatrixAccessController(Sofa.Core.Controller):
    ...
    def onAnimateEndEvent(self, event):
        ...
        if ((self.cutting == True) & (useKalmanFilter == True)):
            ...
            #Perform Kalman Filter sensor fusion (if needed)

...
addPortal = False
addCuttingPortal = False
addPCL = True
addACL = True
addTibia = True
addFemur = True
addSkin = False
addLateralMeniscus = False
addLateralMeniscusWithTear = True
...
def createScene(rootNode):
    ...
    driver = rootNode.addObject('GeomagicDriver', name='GeomagicDevice', deviceName="Default Device", scale="10", drawDeviceFrame="0", positionBase="-150 0 70", drawDevice="0", orientationBase="0 0.707 0 -0.707", maxInputForceFeedback = "3") #, forceFeedBack="@instrument/LCPFF")  #scale attribute only affects position
    ...
    if addFemur == True:
        ...
        femurVisu.addObject('MeshOBJLoader', name="loader", filename="mesh/FEMUR_AND_PATELLA_MEDULLAR.obj", rotation="-85 277 -185", translation="120 106 -80", scale3d="0.0545 0.0545 0.0545")
        femurVisu.addObject('OglModel', name="FemurVisualModel", src="@loader", color="1.0 1.0 1.0 0.4") # color="white") 

        #Femur collision model
        femurCollision = femur.addChild('femurCollision')
        femurCollision.addObject('MeshOBJLoader', name="loader", filename="mesh/FEMUR_AND_PATELLA_MEDULLAR.obj", rotation="-85 277 -185", translation="120 106 -80", scale3d="0.0545 0.0545 0.0545") 
    ...
    if carving == True:
        ...
        medialSkin.addObject('TetrahedronSetTopologyContainer', name="topo", src="@loader", position="@meshLoader.position", tetrahedra="@meshLoader.tetrahedra")
    ...
    if addPortal == True:
        ...
        portalCollision.addObject('LineCollisionModel', contactStiffness="4.4e-4", simulated="0", moving="0")
        portalCollision.addObject('PointCollisionModel', contactStiffness="4.4e-4", simulated="0", moving="0")
    ...
    if addPortal == True:
        ...
        portalCollision.addObject('MeshOBJLoader', name="loader", filename="mesh/torus_for_collision.obj", triangulate = "true",  rotation="60 180 110", translation="-60 -28 -45", scale3d="4.5 4.5 4.5")   
        portalCollision.addObject('MeshTopology', src="@loader", name="portalCollisionModel")
        portalCollision.addObject('MechanicalObject', src="@loader", name="portalState")
        portalCollision.addObject('TriangleCollisionModel', contactStiffness="4.4e-4", simulated="0", moving="0")
        portalCollision.addObject('LineCollisionModel', contactStiffness="4.4e-4", simulated="0", moving="0")
    ...
    if addSkin == True:
        ...
        skinVisual.addObject('OglModel', name="skinVisualModel", src="@loader", color="0.6 0.5 0.4 0.15") 
    #SKIN NODE
    ...
    if addACL == True:    
        ...
        ACL.addObject('TetrahedronSetTopologyContainer', name="topo", position="@meshLoaderACL.position", tetrahedra="@meshLoaderACL.tetrahedra")
    ...
    if addMedialMeniscus == True:
        ...
        medialMeniscus.addObject('TetrahedronSetTopologyContainer', name="topo", position="@meshLoader.position", tetrahedra="@meshLoader.tetrahedra")
    ...
    if addLateralMeniscusWithTear == True:
        ...
        tornLateralMeniscus.addObject('TetrahedronSetTopologyContainer', name="topo", position="@meshLoader.position", tetrahedra="@meshLoader.tetrahedra")
        ...
        tornLateralMeniscus.addObject('TetrahedralCorotationalFEMForceField', template="Vec3d", name="FEM", poissonRatio="0.3", youngModulus="6")
